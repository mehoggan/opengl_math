...
namespace opengl_math
{
  ...
  template <typename T, matrix_layout ML>
  matrix_4X4<T, ML>::matrix_4X4(const vector_4d<T> &v0,
    const vector_4d<T> &v1, const vector_4d<T> &v2, const vector_4d<T> &v3) :
    _v0(v0),
    _v1(v1),
    _v2(v2),
    _v3(v3)
  ...
  template <typename T, matrix_layout ML>
  const vector_4d<T> &matrix_4X4<T, ML>::operator[](unsigned short index)
    const
  {
    assert(index < 4);
  ...
  vector_4d<T> operator*(const matrix_4X4<T, ML> &m, const vector_4d<T> &v)
  {
    if (ML == column) {
      /* [col][row] */
      T a = m[0][0] * v[0] + m[1][0] * v[1] + m[2][0] * v[2] +
        m[3][0] * v[3];
      T b = m[0][1] * v[0] + m[1][1] * v[1] + m[2][1] * v[2] +
        m[3][1] * v[3];
      T c = m[0][2] * v[0] + m[1][2] * v[1] + m[2][2] * v[2] +
        m[3][2] * v[3];
      T d = m[0][3] * v[0] + m[1][3] * v[1] + m[2][3] * v[2] +
        m[3][3] * v[3];
      return vector_4d<T>(a, b, c, d);
    } else {
      /* [row][col] */
      T a = m[0][0] * v[0] + m[0][1] * v[1] + m[0][2] * v[2] +
        m[0][3] * v[3];
      T b = m[1][0] * v[0] + m[1][1] * v[1] + m[1][2] * v[2] +
        m[1][3] * v[3];
      T c = m[2][1] * v[0] + m[2][1] * v[1] + m[2][2] * v[2] +
        m[2][3] * v[3];
      T d = m[3][1] * v[0] + m[3][1] * v[1] + m[3][2] * v[2] +
        m[3][3] * v[3];
      return vector_4d<T>(a, b, c, d);
    }
  }
  ...
  */
  ...
  vector_4d<T> operator*(const vector_4d<T> &v, const matrix_4X4<T, ML> &m)
  {
    if (ML == column) {
      ...
      T c = v[0] * m[2][0] + v[1] * m[2][1] + v[2] * m[2][2] +
        v[3] * m[2][3];
      T d = v[0] * m[3][0] + v[1] * m[3][1] + v[2] * m[3][2] +
        v[3] * m[3][3];
      return vector_4d<T>(a, b, c, d);
    } else if (ML == row) {
      /* [row][col] */
      T a = v[0] * m[0][0] + v[1] * m[1][0] + v[2] * m[2][0] +
        v[3] * m[3][0];
      T b = v[0] * m[0][1] + v[1] * m[1][1] + v[2] * m[2][1] +
        v[3] * m[3][1];
      T c = v[0] * m[0][2] + v[1] * m[1][2] + v[2] * m[2][2] +
        v[3] * m[3][2];
      T d = v[0] * m[0][3] + v[1] * m[1][3] + v[2] * m[2][3] +
        v[3] * m[3][3];
      return vector_4d<T>(a, b, c, d);
    }
  }
  ...
  bool operator==(const matrix_4X4<T, ML1> &lhs,
    const matrix_4X4<T, ML2> &rhs)
  {
